...
export const INVALID_MAXLENGTH_MESSAGE = `Максимальная длина поля - ${USERNAME_MAX_LENGTH} символов`

export const INVALID_EMAIL_MESSAGE = 'Некорректный формат email'
